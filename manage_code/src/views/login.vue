      ...
      <el-form :model="loginForm" class="login_form">
        ...
        <div class="btn_view">
          ...
          <el-button
            class="register"
            type="primary"
            @click="handleRegister('gongzuorenyuan')"
            >注册工作人员</el-button
          >
        </div>
      </el-form>
  ...
  context
    ...
    .then(
      (res) => {
        ...
        if (tableName.value == 'gongzuorenyuan') {
...
.login_view {
  background-image: url('http://localhost:8080/historicDistrict/file/7703c914d6fb429097fef7f9242e37c1.jpg');
  // 表单盒子
  .login_form {
  }
  .title_view {
