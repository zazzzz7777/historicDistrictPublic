		...
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
                    ...
                    <el-button class="statis_btn" type="warning" @click="echartClick1" v-if="btnAuth('yonghu','用户数量统计')">
			...
			<el-table
                ...
                <el-table-column v-if="btnAuth('yonghu','修改')" label="禁用账号" :resizable='true' :sortable='false' align="left" header-align="left">
                    <template #default="scope">
