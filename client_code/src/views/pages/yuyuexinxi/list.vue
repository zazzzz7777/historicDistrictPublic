	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('yuyuexinxi','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="街区名称" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.jiequmingcheng}}
							</template>
						</el-table-column>
						<el-table-column label="景点名称" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.jingdianmingcheng}}
							</template>
						</el-table-column>
						<el-table-column label="景点类型" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.jingdianleixing}}
							</template>
						</el-table-column>
						<el-table-column label="开放时间" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="预约数" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.yuyueshu}}
							</template>
						</el-table-column>
						<el-table-column label="用户名" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="手机号码" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.shoujihaoma}}
							</template>
						</el-table-column>
						<el-table-column label="身份证号" :resizable='true' align="left" header-align="left">
							<template #default="scope">
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/yuyuexinxiAdd')
	}
	//判断是否从个人中心跳转
