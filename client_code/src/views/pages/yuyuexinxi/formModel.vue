	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">预约数</div>
					<div  class="info_text" >{{detail.yuyueshu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">用户名</div>
					<div  class="info_text" >{{detail.yonghuming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('yuyuexinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('yuyuexinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
